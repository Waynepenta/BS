...
//    [self analyData];
    ...
    [self.tableV registerNib:[UINib nibWithNibName:@"TopicCell" bundle:nil] forCellReuseIdentifier:identifier];
...
{
    TopicCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier forIndexPath:indexPath];
...
//    TopicCommentModel *model1 = self.commentArr[indexPath.row];
...

{
    ...
    ShowMessageViewController *view1 = [[ShowMessageViewController alloc] init];
    
    TopicModel *model = self.dataArray[indexPath.row];
    
    
    view1.topicmodel = model;
